...
function Card({prop}) {
  return (
    ...
    <div className="bg-[#14141480] hover:shadow-lg hover:shadow-[#703bf7] max-sm:h-[10rem] sm:w-[350px] flex text-white justify-between lg:w-[20vw]  md:max-w-[50vw] flex-col p-4 max-sm:w-[92vw] md:h-[400px] sm:h-[380px]  max-md:min-h-[400px] py-[0.75rem] rounded-lg my-4">
