  ...
  try {
    ...
    return (
      <main className='overflow-x-hidden w-full md:h-screen py-[1rem] bg-black'>
        <div className="w-full flex gap-[2rem] justify-center items-center px-[5rem] h-full">
          <div className="w-1/2">
            <div className="">
              <Image src={propertyData.images[0]} className='rounded-lg w-full' width={1000} height={1000} />
            </div>
            <div className="">
            </div>
          </div>
          <div className="w-1/2">
            ...
            <div className="w-full py-[1rem] justify-center items-center gap-[1rem] flex">
              <div className="w-1/3 bg-[#703bfd] rounded-lg py-[0.75rem] font-semibold text-white text-center">{propertyData.area} Square feet</div>
              <div className="w-1/3 bg-[#703bfd] rounded-lg py-[0.75rem] font-semibold text-white text-center">{propertyData.num_bedrooms} Bedrooms</div>
              <div className="w-1/3 bg-[#703bfd] rounded-lg py-[0.75rem] font-semibold text-white text-center">{propertyData.num_bathrooms} Bathrooms</div>
            </div>
            <div className="">
